...
// This verifies if the encryption hash is compatible with the encrypted String, thus allowing you to manage the legitimacy of your data.
...
// Return of results
console.log(stringHashVerification);